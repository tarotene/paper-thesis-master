...
\begin{figure}[htbp]
	\centering
	\subcaptionbox{\label{subcap:one-dim}}[0.49\linewidth]{\raisebox{.70\height}{\includegraphics[width=0.35\linewidth]{Fig2Modified.pdf}}}
	\subcaptionbox{\label{subcap:two-dim}}[0.49\linewidth]{\includegraphics[width=0.35\linewidth]{Fig3Modified.pdf}}
	\caption{Sketches of the models considered in Ref.~\cite{Hucht2009b}. Both cases depict a schematic view after the sliding by twice a lattice constant: (\subref{subcap:one-dim}) Two chains of the one-dimensional model; (\subref{subcap:two-dim}) Two square lattices of the two-dimensional model. Letters $k$ and $l$ denote the coordinates on $z$ and $x$ axes, respectively. Reprinted Figs.~2 and 3 with permission from \fullcite{Hucht2009b}. Copyright (2018) by the American Physical Society.}
