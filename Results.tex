...
\begin{figure}[htbp]
	...
	\caption{Temperature dependences of $\epsilon_{\rm b}(L_{z}, T)$ with each boundary condition: (\subref{fig:fricDens_Allsize_AP}) The anti-parallel boundary conditions; (\subref{fig:fricDens_Allsize_P}) The parallel boundary conditions.}
...
\footnotetext{Reprinted Fig.~15 with permission adapted from \fullcite{Hucht2009b}. Copyright (2018) by the American Physical Society.}
